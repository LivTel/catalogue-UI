...
JS9.imageOpts = {
    ...
    zscalecontrast: 0.01,		// default from ds9
...
JS9.lightOpts = {
	...
	textWin:  "width=830px,height=600px,center=1,resize=1,scrolling=1",
	...
	paramWin: "width=440px,height=440px,center=1,resize=1,scrolling=1",
...
JS9.Helper.prototype.connect = function(type){
	...
	/*$.ajax({
		...
		var ii, d;
		that.socket = io.connect(this.url);
